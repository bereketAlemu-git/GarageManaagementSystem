...
int TestControl::printCustomersTest(){
    ...
    if (error == 0){
        ...
        cout<<"Customer names not found lost 2 marks"<<endl;
    }
    ...
    if (error == 0){
        ...
        cout<<"Vehicle make not found lost 2 marks"<<endl;
    }
    ...
    if (error == 0){
        ...
        cout<<"Vehicle model not found lost 2 marks"<<endl;
    }
...
int TestControl::printMechanicsTest(){
    ...
    if (error == 0){
        ...
        cout<<"Mechanic names not found lost 4 marks"<<endl;
    }
...
int TestControl::findCustomer(int index){
    ...
    if (error == 0){
        ...
        cout<<"Customer name "<<customers[index]<<" not found lost 1 mark"<<endl;
    }
    ...
    if (error == 0){
        ...
        cout<<"Vehicle make "<<makes[index]<<" not found lost 1 mark"<<endl;
    }
    ...
    if (error == 0){
        ...
        cout<<"Vehicle model "<<models[index]<<" not found lost 1 mark"<<endl;
    }
    ...
    if (error == 0){
        ...
        cout<<"Vehicle year "<<yearsStr[index]<<" not found lost 1 mark"<<endl;
    }
...
int TestControl::addRepairTest(){
    ...
    if (error == 0){
        ...
        cout<<"Repairs not found lost 2 marks"<<endl;
    }
    ...
    if (error == 0){
        ...
        cout<<"Wrong repairs found lost 2 marks"<<endl;
    }
...
int TestControl::makeRepairTest(){
    ...
    */
    ...
    if (error == 0){
        ...
        cout<<"Mechanic name not found lost 2 marks"<<endl;
    }
    ...
    if (error == 0){
        ...
        cout<<"Customer repairs not found lost 2 marks"<<endl;
    }
